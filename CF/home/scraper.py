"""
Home Scraper - Cloudflare R2 Version (Concurrent Subcategory Scraping)
Scrapes https://www.sheeel.com/ar/home.html and all subcategories
...
class HomeScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/home.html"
        self.category = "home"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/home/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🏠 HOME SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"home_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"home_{timestamp}.xlsx"
    ...
    def run(self):
        """Main execution flow"""
        print("\n" + "="*70)
        print("🏠 HOME SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
        ...
        # Step 2: Download images (and upload to R2 incrementally)
