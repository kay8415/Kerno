# Home Category Scraper

Automated scraper for the Home category on **sheeel.com** with **concurrent subcategory scraping**.

## Category Details

- **URL:** https://www.sheeel.com/ar/home.html
- **Category:** home
        ...
        └── month=04/
            └── day=15/
                └── home/
                    ...
                    │   └── ...
                    └── excel-files/
                        └── home_20260415_120000.xlsx
```

### Excel Structure

**Multiple sheets:**
- One sheet per subcategory (e.g., furniture, kitchen, bedroom, bathroom, etc.)
...
- **Schedule:** Every 2 days at 5:00 AM UTC
- **Manual Trigger:** Actions → Kerno Scrapers → Run workflow

## Technical Details

**Base Class:** `HomeScraper`
...
aws s3 ls s3://{bucket}/sheeel_data/year=2026/month=04/day=15/home/ --recursive

# Download Excel file
aws s3 cp s3://{bucket}/sheeel_data/year=2026/month=04/day=15/home/excel-files/home_*.xlsx .
```
